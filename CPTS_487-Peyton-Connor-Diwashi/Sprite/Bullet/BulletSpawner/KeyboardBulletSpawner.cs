...
namespace CPTS_487_Peyton_Connor_Diwashi
{
    public class KeyboardBulletSpawner : BulletSpawner
    {
        ...
        public KeyboardBulletSpawner(Enemy parent, Texture2D bulletTex, Vector2 position, Movement movement, int width, int height, Movement.CardinalDirection direction) : base(parent, bulletTex, position, movement, width, height)
        {
