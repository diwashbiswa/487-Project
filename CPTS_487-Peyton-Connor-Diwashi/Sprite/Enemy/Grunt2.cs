...
namespace CPTS_487_Peyton_Connor_Diwashi
{
    public class Grunt2 : Enemy
    {
        ...
        public Grunt2(Vector2 position, Texture2D texture, Texture2D bulletTexture, ref Rectangle bounds) : base(position, texture)
        {
        ...
        protected override void Attack(GameTime gameTime, Vector2 target)
        {
            ...
            {
                Bullet b = new Bullet(this.Position, Movement.CardinalDirection.South, this.bulletTexture, 6.0f, 3.0f);
